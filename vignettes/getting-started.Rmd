...
- **[TreeHarp Tutorial](treeharp_class.html)**: learn AST-based static
  analysis: detect `for` loops, check function signatures, and more
- **[Complete Workflow](demo_workflow.html)**: a detailed end-to-end walkthrough
  with a real data analysis assignment
- **[Shiny Apps](shiny_grading.html)**: use the Grading App, Similarity App,
  and Student Solution Checker
- **[Function Reference](../reference/index.html)**: full API documentation
