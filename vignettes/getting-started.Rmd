...
# $env: the knitted solution environment (contains .rf, .X, .test_results)
# $test_fname: path to the generated test script
str(soln)
```
...
| Additional columns | Correctness test results from `check_correctness` |
